...
public class Example1 {
    public static void main(String[] args) {
        ...
        // - ArrayList , Vector , LinkedList 클래스
            // 동기화 : 여러 스레드가 하나의 함수를 동시에 호출했을 때 호출순서대로 해당 함수를 끝날 때까지 점유 상태
        ...
        //========리스트 순회 [처음부터 끝까지 조회]======
        //1. 일반 for문
        System.out.println("for문 리스트 순회: ");
